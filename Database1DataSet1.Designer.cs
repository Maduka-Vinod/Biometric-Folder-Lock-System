...
namespace Project {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class FolderDataTable : global::System.Data.TypedTableBase<FolderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FolderRow AddFolderRow(string Path, string Status) {
        ...
        public partial class FolderRow : global::System.Data.DataRow {
            ...
            public string Status {
                get {
                    try {
                        return ((string)(this[this.tableFolder.StatusColumn]));
                    }
...
namespace Project.Database1DataSet1TableAdapters {
    ...
    public partial class FolderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Folder] WHERE (([Id] = @Original_Id) AND ([Path] = @Original_P" +
                "ath) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Sta" +
                "tus)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Folder] ([Path], [Status]) VALUES (@Path, @Status);\r\nSELECT Id" +
                ", Path, Status FROM Folder WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Folder] SET [Path] = @Path, [Status] = @Status WHERE (([Id] = @Original_Id) AND ([Path] = @Original_Path) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT Id, Path, Status FROM Folder WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Path, Status FROM dbo.Folder";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Path, Status FROM dbo.Folder";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Id, Path, Status FROM dbo.Folder";
        ...
        public virtual int Fill(Database1DataSet1.FolderDataTable dataTable) {
        ...
        public virtual Database1DataSet1.FolderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.FolderDataTable dataTable = new Database1DataSet1.FolderDataTable();
        ...
        public virtual int FillBy(Database1DataSet1.FolderDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(Database1DataSet1.FolderDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.FolderDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Path, string Original_Status) {
        ...
        public virtual int Insert(string Path, string Status) {
            if ((Path == null)) {
        ...
        public virtual int Update(string Path, string Status, int Original_Id, string Original_Path, string Original_Status, int Id) {
            if ((Path == null)) {
                throw new global::System.ArgumentNullException("Path");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Path, string Status, int Original_Id, string Original_Path, string Original_Status) {
            return this.Update(Path, Status, Original_Id, Original_Path, Original_Status, Original_Id);
        }
    }
