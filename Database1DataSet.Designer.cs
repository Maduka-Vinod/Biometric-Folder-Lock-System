...
namespace Project {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class FolderDataTable : global::System.Data.TypedTableBase<FolderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FolderRow AddFolderRow(string Path) {
...
namespace Project.Database1DataSetTableAdapters {
    ...
    public partial class FolderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Folder] ([Path]) VALUES (@Path);\r\nSELECT Id, Path FROM Folder " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Folder] SET [Path] = @Path WHERE (([Id] = @Original_Id) AND ([Path]" +
                " = @Original_Path));\r\nSELECT Id, Path FROM Folder WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Path FROM dbo.Folder";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Path FROM dbo.Folder";
        ...
        public virtual int Fill(Database1DataSet.FolderDataTable dataTable) {
        ...
        public virtual Database1DataSet.FolderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.FolderDataTable dataTable = new Database1DataSet.FolderDataTable();
        ...
        public virtual int FillBy(Database1DataSet.FolderDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.FolderDataTable dataTable) {
        ...
        public virtual int Insert(string Path) {
            if ((Path == null)) {
        ...
        public virtual int Update(string Path, int Original_Id, string Original_Path, int Id) {
            if ((Path == null)) {
                throw new global::System.ArgumentNullException("Path");
            }
            else {
            ...
            if ((Original_Path == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_Path));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Path, int Original_Id, string Original_Path) {
            return this.Update(Path, Original_Id, Original_Path, Original_Id);
        }
    }
